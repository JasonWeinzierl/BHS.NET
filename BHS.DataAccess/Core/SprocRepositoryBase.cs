...
namespace BHS.DataAccess.Core
{
    ...
    public abstract class SprocRepositoryBase
    {
        ...
        #region Cell Converters
        /// <summary>
        /// Cast cell to long
        /// </summary>
        protected static long ToLong(object cell)
        {
            return ToNullableLong(cell) ?? default;
        }

        /// <summary>
        /// Cast cell to nullable long
        /// </summary>
        protected static long? ToNullableLong(object cell)
        {
        ...
        /// Cast cell to int
        /// </summary>
        protected static int ToInt(object cell)
        {
            return ToNullableInt(cell) ?? default;
        }

        /// <summary>
        /// Cast cell to nullable int
        /// </summary>
        protected static int? ToNullableInt(object cell)
        {
        ...
        /// Cast cell to short
        /// </summary>
        protected static short ToShort(object cell)
        {
            return ToNullableShort(cell) ?? default;
        }

        /// <summary>
        /// Cast cell to nullable short
        /// </summary>
        protected static short? ToNullableShort(object cell)
        {
        ...
        /// Cast cell to byte
        /// </summary>
        protected static byte ToByte(object cell)
        {
            return ToNullableByte(cell) ?? default;
        }

        /// <summary>
        /// Cast cell to nullable byte
        /// </summary>
        protected static byte? ToNullableByte(object cell)
        {
        ...
        /// </summary>
        protected static decimal ToDecimal(object cell)
        {
            return ToNullableDecimal(cell) ?? default;
        }

        /// <summary>
        /// Cast cell to nullable decimal
        /// </summary>
        protected static decimal? ToNullableDecimal(object cell)
        {
        ...
        /// Cast cell to string
        /// </summary>
        protected static string ToString(object cell)
        {
        ...
        /// Cast cell to char
        /// </summary>
        protected static char ToChar(object cell)
        {
            return ToNullableChar(cell) ?? default;
        }

        /// <summary>
        /// Cast cell to nullable char
        /// </summary>
        protected static char? ToNullableChar(object cell)
        {
        ...
        /// </summary>
        protected static DateTimeOffset ToDateTimeOffset(object cell)
        {
            return ToNullableDateTimeOffset(cell) ?? default;
        }

        /// <summary>
        /// Cast cell to nullable DateTimeOffset
        /// </summary>
        protected static DateTimeOffset? ToNullableDateTimeOffset(object cell)
        {
        ...
        /// Cast cell to bool
        /// </summary>
        protected static bool ToBool(object cell)
        {
            return ToNullableBool(cell) ?? default;
        }

        /// <summary>
        /// Cast cell to nullable bool
        /// </summary>
        protected static bool? ToNullableBool(object cell)
        {
