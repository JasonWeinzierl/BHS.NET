...
module "auth" {
  ...
  auth0_connection_name = "Username-Password-Authentication2"
}
...
module "build_server" {
  ...
  e2e_url                = "https://staging.beltonhistoricalsociety.org"
...
module "mongo" {
  ...
  cosmos_account_name = "staging-bhsmongo"
