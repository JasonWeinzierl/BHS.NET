...
public interface IDbExecuter
{
    ...
    Task<T?> ExecuteSprocQuerySingleOrDefault<T>(string connectionStringName, string commandText, object? parameters = null, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<T>> ExecuteSprocQuery<T>(string connectionStringName, string commandText, object? parameters = null, CancellationToken cancellationToken = default);
    ...
    Task<(IEnumerable<T1> resultset1, IEnumerable<T2> resultset2)> ExecuteSprocQueryMultiple<T1, T2>(string connectionStringName, string commandText, object? parameters = null, CancellationToken cancellationToken = default);
}
